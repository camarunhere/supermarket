...
import CardFeature from "../component/CardFeature.js";
      ...
      <div className="md:flex gap-4 py-2">
        <div className="md:w-1/2 ">
          <div className="flex gap-3 bg-slate-300 w-36 px-2 items-center rounded-full">
            ...
            <img
              src="https://cdn-icons-png.flaticon.com/512/6947/6947616.png"
              className="h-7"
            />
          </div>
          ...
          <button className="font-bold bg-red-500 text-slate-200 px-4 py-2 rounded-full">
            Order Now
          </button>
        </div>
        ...
        >
          {homeProductCartListVegetables[0]
            ...
            : loadingArrayFeature.map((el,index) => (
              ...
              <AllProduct heading={"You are Searching for"}/>
    </div>
  );
};
